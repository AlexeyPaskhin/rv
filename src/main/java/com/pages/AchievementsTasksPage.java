...
public class AchievementsTasksPage extends AbstractPage {
    ...
    private Element PROMO_CODE_FOR_FIRST_STEPS = new Element(By.xpath("//h5[text()='Первые шаги']/..//div[@class='achievement-task__tooltip-code']"));
    ...
    private Button GET_GIFT_FOR_NOT_A_DAY_WITHOUT_A_SLOT = new Button(By.xpath("//h5[text()='Ни дня без слота']/..//button[contains(text(), 'Забрать подарок')]"));
    private Element PROMO_CODE_FOR_NOT_A_DAY_WITHOUT_A_SLOT = new Element(By.xpath("//h5[text()='Ни дня без слота']/..//div[@class='achievement-task__tooltip-code']"));
    ...
    private Button GET_GIFT_FOR_AH_ONCE_AND_AGAIN = new Button(By.xpath("//h5[text()='Эх, раз, да ещё раз']/..//button[contains(text(), 'Забрать подарок')]"));
    private Element PROMO_CODE_FOR_AH_ONCE_AND_AGAIN = new Element(By.xpath("//h5[text()='Эх, раз, да ещё раз']/..//div[@class='achievement-task__tooltip-code']"));
    ...
    @Step
    public AchievementsTasksPage clickGetGiftForNotADayWithoutASlot() {
        GET_GIFT_FOR_NOT_A_DAY_WITHOUT_A_SLOT.click();
        return this;
    }
}
