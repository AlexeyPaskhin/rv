...
//            driver = new EventFiringWebDriver(new RemoteWebDriver(url, cap)).register(events); // for remote usage
            driver = new EventFiringWebDriver(new ChromeDriver()).register(events); // for local usage
